...
validateRegex.validateGeneric = () =>{
    return true
}
validateRegex.validateTelefono = () =>{
    return true
}
validateRegex.validateNombreCompleto = () =>{
    return true
}
...
validateRegex.validateEmail = (email) => {
...
validateRegex.validatePasswordModerate = (password) => {
...
validateRegex.validateUsername = (username) => {
